...
public class VoucherUpdateButtonState extends InstallButton {
    protected Button btn;
    protected ProgressBar pb;
    private static DecimalFormat decimalFormat = new DecimalFormat("0.00");
    public VoucherUpdateButtonState(GameBaseDetail game, Button btn, ProgressBar pb) {
        super(game);
        this.btn = btn;
        this.pb = pb;
    }
