...
public class PictureFlow extends Gallery {
    ...
    public PictureFlow(final Context context) {
        super(context);
...
//    public NewCoverFlow(final Context context, final AttributeSet attrs) {
//        this(context, attrs, android.R.attr.galleryStyle);
//    }

//    public NewCoverFlow(final Context context, final AttributeSet attrs, final int defStyle) {
...
//        }
//        final BaseAdapter coverAdapter = (BaseAdapter) adapter;
//        
...
//        float translatey = rotation/mMaxRotationAngle * 20;
