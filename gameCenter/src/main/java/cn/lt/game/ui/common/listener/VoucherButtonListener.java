...
/**
 * Created by Erosion on 2018/3/1.
 */

public class VoucherButtonListener{
    ...
    public VoucherButtonListener(Context context, GameBaseDetail game, InstallButton btn, String pageName) {
        mContext = context;
        mGame = game;
        mBtn = btn;
    ...
    public boolean realOnClick(View v, String mPageName) {
        final int state = mGame == null ? 0 : mGame.getState();
        // 下载流程；
        if (hasOnclick) {
...
//                                            newUrlBean.setDownload_url("http://appcenter.dev.ttigame.cn/uploads/apks/9/9/99014b7ec869b4be9650c5485820b3f1.apksss");
            ...
            case InstallState.installComplete: {
                ...
                if (!OpenAppUtil.openApp(mGame, mContext,pageName)) {
