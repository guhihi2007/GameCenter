 ...
 */
package cn.lt.game.ui.common.quickadpter;
...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setTextSize(int viewId, float textSize) {
        TextView view = retrieveView(viewId);
     ...
     * @return
     */
    public BaseAdapterHelper setImageUil(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
//        ImageLoader.getInstance().display(imageUrl, view, R.mipmap.desktop_icon, 0);
        ImageloaderUtil.loadUserHead(context, imageUrl, view);
        return this;
    }
     ...
     * @return
     */
    public BaseAdapterHelper setRadiusImage(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
//        ImageLoader.getInstance().displayLogo(imageUrl, view);
        ImageloaderUtil.loadLTLogo(context, imageUrl, view);
        return this;
    }
    ...
    public BaseAdapterHelper setImageLevel(int viewId, int imageLevel) {
        ImageView view = retrieveView(viewId);
