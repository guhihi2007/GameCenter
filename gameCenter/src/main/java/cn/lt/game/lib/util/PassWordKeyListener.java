...
public class PassWordKeyListener extends NumberKeyListener
{
     ...
     */
    public PassWordKeyListener(boolean sign, boolean decimal) {
        mSign = sign;
        mDecimal = decimal;
     ...
     */
    public static PassWordKeyListener getInstance(String accepted) {
        // TODO: do we need a cache of these to avoid allocating?

    	PassWordKeyListener dim = new PassWordKeyListener();
