...
public class WheelTimeMain {
	...
	private static int CUR_YEAR = Integer.parseInt(TimeUtils.getLongtoYear(System.currentTimeMillis()));
	private static int START_YEAR = 1971, END_YEAR = CUR_YEAR;
	...
	public WheelTimeMain(View view) {
		super();
		this.view = view;
		hasSelectTime = false;
		setView(view);
	}
	public WheelTimeMain(View view,boolean hasSelectTime) {
		super();
		this.view = view;
...
//			textSize = (screenheight / 100) * 4;
		...
		int	textSize = view.getContext().getResources().getDimensionPixelOffset(R.dimen.font16sp);
