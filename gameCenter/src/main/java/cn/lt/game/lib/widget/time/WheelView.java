...
public class WheelView extends View {
     ...
     */
    private int ITEM_OFFSET = TEXT_SIZE / 2;
...
//	private GradientDrawable bottomShadow;
    ...
    private void initData(Context context) {
        ...
        ADDITIONAL_ITEM_HEIGHT = context.getResources().getDimensionPixelOffset(R.dimen.user_center_48)/2;//context.getResources().getDimensionPixelOffset(R.dimen.user_center_48)/2;
    }
...
//		}
     ...
     setBackgroundResource(R.color.white);//(R.drawable.wheel_bg);
     }
...
//                - ADDITIONAL_ITEM_HEIGHT;
    ...
    private String buildText(boolean useCurrentValue) {
        ...
        for (int i = currentItem - addItems; i <= currentItem + addItems; i++) {
            if (useCurrentValue || i != currentItem) {
                ...
                if (text != null) {
                    itemsText.append(substring(text));
                }
            }
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (!isScrollingPerformed
            ...
            String text = getAdapter() != null ? getAdapter().getItem(
                    currentItem) : null;
            text = text != null ? text : "";
            valueLayout = new StaticLayout(substring(text),
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            Log.e("wheel","getDesiredHeight:"+height);
        ...
        ITEM_OFFSET = -(getItemHeight()/2)+TEXT_SIZE/2;
        Log.e("wheel","height:"+ITEM_OFFSET);
    }
...
//	}
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        topDrawable.setBounds(0, 0, getWidth(), height / visibleItems);
        topDrawable.draw(canvas);

        bottomDrawable.setBounds(0, height - height / visibleItems,
				getWidth(), height);
